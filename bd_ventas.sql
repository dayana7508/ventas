...
select max(comisión) as 'comisión mayor' from comercial;
...
select id, nombre, apellido1 from cliente where apellido2 is not null order by nombre, apellido1, apellido2 desc;
